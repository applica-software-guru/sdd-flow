const features = [
  {
    ...
    description:
      "Get a bird's-eye view of all your SDD projects with real-time stats and status tracking.",
  ...
  },
  {
    ...
    description:
      'Manage the full CR lifecycle from draft to approval to applied, with assignments and comments.',
  ...
  },
  {
    title: 'Documentation',
    description:
      'View and edit your SDD documentation tree in the browser, fully synced with your CLI workspace.',
  ...
  },
  {
    ...
    description:
      'RBAC roles, assignments, real-time notifications, and comments on every work item.',
  ...
  },
  {
    title: 'Audit Log',
    description:
      'Complete history of every change, approval, and status transition across your organization.',
...
export default function FeaturesSection() {
  return (
    <section id="features" className="scroll-mt-14 px-4 py-20 sm:py-24 lg:py-32">
