    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 via-white to-slate-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-20 sm:px-6 sm:pb-24 sm:pt-28 lg:px-8 lg:pb-32 lg:pt-36">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1
            className="animate-fade-in-up mt-6 text-4xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-5xl lg:text-6xl"
          ...
          <p
            className="animate-fade-in-up mx-auto mt-6 max-w-2xl text-lg text-slate-600 dark:text-slate-400 sm:text-xl"
            style={{ animationDelay: '0.2s', animationFillMode: 'both' }}
          >
            The companion platform for the SDD CLI. Manage change requests, track bugs, collaborate
            with your team, and keep your documentation in sync.
          </p>
        ...
        {/* Product mockup */}
        <div
          className="animate-fade-in-up mx-auto mt-16 max-w-5xl sm:mt-20"
          ...
          <div className="rounded-2xl border border-slate-200/80 bg-white p-2 shadow-2xl ring-1 ring-slate-900/5 dark:border-slate-700 dark:bg-slate-800 dark:ring-white/5">
            ...
            <div className="p-6">
              ...
              <div className="mt-6 space-y-2">
                {[
                  {
                    title: 'CR-014: Update authentication flow',
                    status: 'Approved',
                    statusColor:
                      'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400',
                  },
                  {
                    title: 'BUG-007: Search returns stale results',
                    status: 'Open',
                    statusColor: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400',
                  },
                  {
                    title: 'CR-015: Add API rate limiting',
                    status: 'Draft',
                    statusColor:
