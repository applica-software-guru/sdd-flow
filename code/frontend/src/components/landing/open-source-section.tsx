export default function OpenSourceSection() {
  return (
    <section id="open-source" className="scroll-mt-14 px-4 py-20 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
          SDD Flow is fully open source. Run it on our cloud or deploy it on your own infrastructure
          with Docker. Your data, your rules.
        </p>
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-3">
          {['React', 'TypeScript', 'FastAPI', 'PostgreSQL', 'Tailwind CSS', 'Docker'].map(
            (tech) => (
              <span
                key={tech}
