        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">
              From solo developers to large organizations, SDD Flow scales with your team and keeps
              everyone aligned.
            </p>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xl dark:border-slate-700 dark:bg-slate-800">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={member.name}
                  className="flex items-center justify-between rounded-lg border border-slate-100 bg-slate-50 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/50"
                >
                  ...
                  <span
                    className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${member.color}`}
                  >
                    {member.role}
                  </span>
                </div>
