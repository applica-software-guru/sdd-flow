      ...
      <div className="flex items-center gap-4">
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            <span className="truncate text-sm font-medium text-slate-900 dark:text-slate-100" title={user?.email}>
              {user?.email}
            </span>
            {user?.email_verified && (
...
function SecuritySection() {
  ...
  if (googleOnly && !showSetPassword) {
    return (
      <Card
        title="Security"
        description="How you sign in to SDD Flow."
      >
          ...
          <div className="flex min-w-0 items-center gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">
                Your account {user?.email} is managed by Google — there is no
