    ...
    <div className="mx-auto max-w-5xl">
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3">
        <input
          ...
          className="rounded-md border border-slate-300 bg-white px-3 py-2 text-sm shadow-sm placeholder-slate-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
        />
        <select
          value={entityType}
          onChange={(e) => {
              ...
              <tbody className="divide-y divide-slate-100">
                {data.items.map((entry) => (
                  <tr key={entry.id} className="hover:bg-slate-50">
                    ...
                    <td className="hidden px-6 py-3 text-xs text-slate-400 lg:table-cell">
                      {entry.details
