                ...
                >
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="truncate text-sm font-medium text-slate-900 dark:text-slate-100" title={member.email}>
                        {member.display_name}
                      </p>
                      <p className="truncate text-xs text-slate-500 dark:text-slate-400" title={member.email}>
                        {member.email}
                      </p>
                    </div>
                  </div>
